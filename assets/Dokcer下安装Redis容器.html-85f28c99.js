import{_ as d,r,o,c as l,a as n,b as s,d as a,e as i}from"./app-f6585042.js";const c={},t=n("h1",{id:"dokcer下安装redis容器",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#dokcer下安装redis容器","aria-hidden":"true"},"#"),s(" Dokcer下安装Redis容器")],-1),p=n("h3",{id:"_1、获取redis镜像",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1、获取redis镜像","aria-hidden":"true"},"#"),s(" 1、获取Redis镜像")],-1),u={href:"https://hub.docker.com/_/redis?tab=tags",target:"_blank",rel:"noopener noreferrer"},v=i(`<h3 id="_2、下载redis镜像" tabindex="-1"><a class="header-anchor" href="#_2、下载redis镜像" aria-hidden="true">#</a> 2、下载Redis镜像</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull redis
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3..docker 启动 redis</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">--name</span> redis <span class="token parameter variable">-p</span> <span class="token number">6379</span>:6379 <span class="token punctuation">\\</span>
...
<span class="token function">docker</span> <span class="token function">ps</span> <span class="token operator">|</span> <span class="token function">grep</span> redis
   ...
   get dong 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function B(y,N){const e=r("ExternalLinkIcon");return o(),l("div",null,[t,p,n("blockquote",null,[n("p",null,[s("Docker如果想安装软件 , 必须先到 Docker 镜像仓库下载镜像。 "),n("a",u,[s("Docker 镜像仓库"),a(e)])])]),v,n("p",null,[s("2.下载官网的配置文件并修改 redis.conf："),n("a",m,[s("redis.conf下载"),a(e)])]),b,n("blockquote",null,[h,k,f,_,g,x,R,n("p",null,[n("a",D,[s("该文章详细说明"),a(e)])])]),q])}const w=d(c,[["render",B],["__file","Dokcer下安装Redis容器.html.vue"]]);export{w as default};
